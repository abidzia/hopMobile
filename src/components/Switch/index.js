...
var { PanResponder, View, TouchableHighlight, Animated } = ReactNative;
...
var MaterialSwitch = React.createClass({
  ...
  getDefaultProps() {
    return {
      active: true,
      style: {},
      inactiveBackgroundColor: "#F5CBA7",
      activeBackgroundColor: "#F5CBA7",
      activeButtonColor: "#FF872C",
      inactiveButtonColor: "#FF872C",
      inactiveButtonPressedColor: "#FF872C",
      activeButtonPressedColor: "#FF872C",
      buttonShadow: {
        shadowColor: "#000",
        shadowOpacity: 0.5,
        shadowRadius: 1,
  ...
  componentWillReceiveProps: function(nextProps) {
    if (nextProps.active != this.props.active) {
      if (nextProps.active) this.activate();
      ...
      >
        ...
        <TouchableHighlight
          ...
          style={{
            ...
            width:
              this.props.switchWidth + doublePadding + this.props.buttonRadius,
            position: "absolute",
            top: 1,
            left: 1
          }}
